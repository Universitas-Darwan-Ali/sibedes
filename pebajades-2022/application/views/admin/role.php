                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/roleEdit/') . $r['role_id']; ?>" class="badge badge-success">edit</a>
                                <a href="<?= base_url('admin/roleDelete/') . $r['role_id']; ?>" class="badge badge-danger" onclick="return confirm('Yakin hapus data?')">delete</a>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
