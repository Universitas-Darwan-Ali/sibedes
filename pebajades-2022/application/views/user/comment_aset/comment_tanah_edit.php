                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <input type="hidden" name="tanah_id" value="<?= $Comment_Tanah['tanah_id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_tanah_id" class="form-control" id="kode_tanah_id" value="<?= $Comment_Tanah['kode_tanah_id']; ?>" READONLY>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nup" class="form-control" id="nup" value="<?= $Comment_Tanah['nup']; ?>" READONLY>
                            <small class="form-text text-danger"><?= form_error('nup'); ?></small>
                        </div>

                        <div class="form-group">
                            <label for="luas">Luas (M<sup>2</sup>)</label>
                            <input type="text" name="luas" class="form-control" id="luas" value="<?= $Comment_Tanah['luas']; ?>" READONLY>
                            <small class="form-text text-danger"><?= form_error('luas'); ?></small>
                        </div>

                        <div class="form-group">
                            <label for="th_perolehan">Tahun Perolehan</label>
                            <input type="text" name="th_perolehan" class="form-control" id="th_perolehan" value="<?= $Comment_Tanah['th_perolehan']; ?>" READONLY>
                            <small class="form-text text-danger"><?= form_error('th_perolehan'); ?></small>
                        </div>

                        <div class="form-group">
                            <label for="alas_hak">Alas/Hak Bukti Kepemilikan</label>
                            <input type="text" name="alas_hak" class="form-control" id="alas_hak" value="<?= $Comment_Tanah['alas_hak']; ?>" READONLY>
                            <small class="form-text text-danger"><?= form_error('alas_hak'); ?></small>
                        </div>

                        <div class="form-group">
                            <label for="nilai_perolehan">Nilai Perolehan (Rp)</label>
                            <input type="text" name="nilai_perolehan" class="form-control" id="nilai_perolehan" value="<?= $Comment_Tanah['nilai_perolehan']; ?>" READONLY>
                            <small class="form-text text-danger"><?= form_error('nilai_perolehan'); ?></small>
                        </div>

                        <div class="form-group">
                            <label for="ket">Keterangan</label>
                            <input type="text" name="ket" class="form-control" id="ket" value="<?= $Comment_Tanah['ket']; ?>" READONLY>
